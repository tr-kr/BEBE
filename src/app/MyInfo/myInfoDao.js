...
async function selectUserId(connection, userId) {
  const selectUserIdQuery = `
                 SELECT account, nickname, age, password, phone_number, email, created_at, updated_at, discord_auth, riot_auth, school_auth, played_competition, played_match, win, lose, birth, emailVerified
                 FROM User 
                 WHERE id = ?;
                 `;
